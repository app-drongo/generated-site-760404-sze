// Enhanced by AI on 2025-08-17T11:39:05.228Z
// Section: cta
// Category: cta
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 leading-tight">
                Elevate Your Manufacturing and
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join thousands of leading manufacturers and logistics companies who have
                transformed their operations with our SAP consulting services. Start your
                journey today with a free trial and experience the difference.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Trusted by leading manufacturing and logistics companies worldwide
                </p>
