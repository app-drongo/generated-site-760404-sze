// Enhanced by AI on 2025-08-17T11:39:04.603Z
// Section: hero
// Category: hero
        ...
        <div className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
              Unlock the power of SAP with our team of experienced consultants. 
              Optimize your manufacturing and warehouse operations for greater efficiency and profitability.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="ml-2">4.9/5 SAP Expertise Rating</span>
              </div>
            </div>
          </div>
